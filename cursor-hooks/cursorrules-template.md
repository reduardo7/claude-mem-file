...
If you want to add custom instructions about claude-mem-file (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/claude-mem-file-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using claude-mem-file memory system"
---

# Memory System Usage

You have access to claude-mem-file, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/claude-mem-file-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/claude-mem-file-instructions.mdc` | MCP tool instructions | You (optional) |
