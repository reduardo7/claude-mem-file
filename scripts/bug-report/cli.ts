...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for claude-mem-file
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for claude-mem-file using the Claude Agent SDK.
...
async function main() {
  ...
  const githubUrl = `https://github.com/thedotmack/claude-mem-file/issues/new?title=${encodedTitle}&body=${encodedBody}`;
