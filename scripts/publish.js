...
/**
 * Release script for claude-mem-file
...
https://github.com/thedotmack/claude-mem-file"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/thedotmack/claude-mem-file/releases/tag/v${newVersion}`);
