...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-alexnewman-Scripts-claude-mem-file/')
...
output_file = os.path.expanduser('~/Scripts/claude-mem-file/all_xml_fragments_with_timestamps.xml')
