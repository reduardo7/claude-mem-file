...
Filesystem analysis of `~/.claude/projects/-Users-alexnewman-Scripts-claude-mem-file/`:
...
The .jsonl files are created by the **Claude Agent SDK** (`@anthropic-ai/claude-agent-sdk`), not by claude-mem-file directly.
