...
**Issue:** [#599](https://github.com/thedotmack/claude-mem-file/issues/599)
...
1. Error message on Claude Code startup when cwd is `C:\`:
   ...
   error: Failed to fetch context: 400
         at C:\Users\achau\.claude\plugins\cache\thedotmack\claude-mem-file\9.0.0\scripts\user-message-hook.js:19:1339
   ```
...
|------|---------|--------------|
| `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/hooks/user-message-hook.ts` | Source hook (needs fix) | Yes |
| `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/plugin/scripts/user-message-hook.js` | Built hook | Auto-rebuilds |
| `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/utils/project-name.ts` | Utility (has fix) | No |
| `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/hooks/context-hook.ts` | Reference implementation | No |
| `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/services/worker/http/routes/SearchRoutes.ts` | API validation | No |
