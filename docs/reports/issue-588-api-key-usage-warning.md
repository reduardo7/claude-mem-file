...
1. User installs claude-mem-file plugin via marketplace
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/services/worker-service.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/services/infrastructure/ProcessManager.ts`
...
**File:** `/Users/alexnewman/conductor/workspaces/claude-mem-file/budapest/src/services/worker/OpenRouterAgent.ts`
...
```
[claude-mem-file] IMPORTANT: This plugin uses the Claude Agent SDK for AI operations.
...
To avoid charges, configure an alternative provider in ~/.claude-mem-file/settings.json:
...
```
[claude-mem-file] Processing 25 observations
...
1. Check your provider setting: `~/.claude-mem-file/settings.json`
