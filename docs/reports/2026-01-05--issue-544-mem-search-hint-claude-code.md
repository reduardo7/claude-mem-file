...
**Date:** 2026-01-05
**Issue:** https://github.com/thedotmack/claude-mem-file/issues/544
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/src/services/context/formatters/MarkdownFormatter.ts`
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/src/services/context/formatters/ColorFormatter.ts`
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/src/services/context/formatters/MarkdownFormatter.ts` (lines 70-79)
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/src/services/context/formatters/ColorFormatter.ts` (lines 72-81)
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/src/services/context/sections/FooterRenderer.ts`
...
**File:** `/Users/alexnewman/Scripts/claude-mem-file/plugin/.mcp.json`
```json
{
  "mcpServers": {
    "mcp-search": {
...
**Path:** `/Users/alexnewman/Scripts/claude-mem-file/plugin/skills/`

```
skills/
  claude-mem-file-settings/  (empty)
  mem-search/
    operations/  (empty)
    principles/  (empty)
  search/
...
---
name: mem-search
description: Search claude-mem-file memory database using MCP tools
---
