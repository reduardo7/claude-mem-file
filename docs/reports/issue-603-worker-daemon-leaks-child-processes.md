...
4118969 1     161656   07:28:16  bun ~/.claude/plugins/cache/thedotmack/claude-mem-file/9.0.0/scripts/worker-service.cjs --daemon
```
...
1. Use claude-mem-file normally throughout a work session
...
The claude-mem-file worker service uses a modular architecture:
...
- **Issue:** https://github.com/thedotmack/claude-mem-file/issues/603
- **Source Files:**
