...
4118969 1     161656   07:28:16  bun ~/.claude/plugins/cache/reduardo7/claude-mem-file/9.0.0/scripts/worker-service.cjs --daemon
```
...
- **Issue:** https://github.com/reduardo7/claude-mem-file/issues/603
- **Source Files:**
