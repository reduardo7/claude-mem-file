...
- **[Hướng Dẫn Sử Dụng](https://docs.claude-mem-file.ai/usage/getting-started)** - Cách Claude-Mem hoạt động tự động
...
- **[Kỹ Thuật Ngữ Cảnh](https://docs.claude-mem-file.ai/context-engineering)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://docs.claude-mem-file.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của Claude-Mem

### Kiến Trúc

- **[Tổng Quan](https://docs.claude-mem-file.ai/architecture/overview)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://docs.claude-mem-file.ai/architecture-evolution)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://docs.claude-mem-file.ai/hooks-architecture)** - Cách Claude-Mem sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://docs.claude-mem-file.ai/architecture/hooks)** - Giải thích 7 hook scripts
- **[Worker Service](https://docs.claude-mem-file.ai/architecture/worker-service)** - HTTP API & quản lý Bun
- **[Cơ Sở Dữ Liệu](https://docs.claude-mem-file.ai/architecture/database)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://docs.claude-mem-file.ai/architecture/search-architecture)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma
...
Xem **[Hướng Dẫn Cấu Hình](https://docs.claude-mem-file.ai/configuration)** để biết tất cả các cài đặt và ví dụ có sẵn.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/thedotmack/claude-mem-file/issues)
