...
- **[Banco de Dados](https://docs.claude-mem-file.ai/architecture/database)** - Schema SQLite e busca FTS5
- **[Arquitetura de Busca](https://docs.claude-mem-file.ai/architecture/search-architecture)** - Busca híbrida com banco de dados vetorial Chroma
...
Claude-Mem-File fornece busca inteligente através da skill mem-search que se auto-invoca quando você pergunta sobre trabalhos anteriores:
...
Veja [Guia de Ferramentas de Busca](https://docs.claude-mem-file.ai/usage/search-tools) para exemplos detalhados.
