...
- **[Hakuarkkitehtuuri](https://docs.claude-mem-file.ai/architecture/search-architecture)** - Hybridihaku Chroma-vektoritietokannalla

### Asetukset ja kehitys

- **[Asetukset](https://docs.claude-mem-file.ai/configuration)** - Ympäristömuuttujat ja asetukset
...
Katso [Arkkitehtuurin yleiskatsaus](https://docs.claude-mem-file.ai/architecture/overview) yksityiskohdista.
...
Katso [Hakutyökalujen opas](https://docs.claude-mem-file.ai/usage/search-tools) yksityiskohtaisia esimerkkejä varten.
...
Asetuksia hallitaan tiedostossa `~/.claude-mem-file/settings.json` (luodaan automaattisesti oletusarvoilla ensimmäisellä suorituskerralla). Määritä AI-malli, worker-portti, datahakemisto, lokitaso ja kontekstin injektointiasetukset.
...
- **Ongelmat**: [GitHub Issues](https://github.com/thedotmack/claude-mem-file/issues)
- **Repositorio**: [github.com/thedotmack/claude-mem-file](https://github.com/thedotmack/claude-mem-file)
