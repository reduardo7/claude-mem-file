...
- **[สถาปัตยกรรมการค้นหา](https://docs.claude-mem-file.ai/architecture/search-architecture)** - การค้นหาแบบไฮบริดด้วยฐานข้อมูลเวกเตอร์ Chroma
...
ดู [ภาพรวมสถาปัตยกรรม](https://docs.claude-mem-file.ai/architecture/overview) สำหรับรายละเอียด
...
ดู [คู่มือเครื่องมือค้นหา](https://docs.claude-mem-file.ai/usage/search-tools) สำหรับตัวอย่างโดยละเอียด
...
ดู **[คู่มือการกำหนดค่า](https://docs.claude-mem-file.ai/configuration)** สำหรับการตั้งค่าทั้งหมดที่มีและตัวอย่าง

---

## การพัฒนา

ดู **[คู่มือการพัฒนา](https://docs.claude-mem-file.ai/development)** สำหรับคำแนะนำการสร้าง การทดสอบ และขั้นตอนการมีส่วนร่วม
...
ดู **[คู่มือการแก้ไขปัญหา](https://docs.claude-mem-file.ai/troubleshooting)** สำหรับปัญหาและการแก้ไขทั่วไป
...
ดู [คู่มือการพัฒนา](https://docs.claude-mem-file.ai/development) สำหรับขั้นตอนการมีส่วนร่วม
...
- **เอกสาร**: [docs/](docs/)
- **ปัญหา**: [GitHub Issues](https://github.com/thedotmack/claude-mem-file/issues)
