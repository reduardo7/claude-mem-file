...
- **[Посібник з використання](https://docs.claude-mem-file.ai/usage/getting-started)** - Як Claude-Mem працює автоматично
...
- **[Прогресивне розкриття](https://docs.claude-mem-file.ai/progressive-disclosure)** - Філософія стратегії підготовки контексту Claude-Mem
...
- **[Архітектура хуків](https://docs.claude-mem-file.ai/hooks-architecture)** - Як Claude-Mem використовує хуки життєвого циклу
