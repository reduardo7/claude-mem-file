...
- **[使用指南](https://docs.claude-mem-file.ai/usage/getting-started)** - Claude-Mem 如何自动工作
...
- **[渐进式披露](https://docs.claude-mem-file.ai/progressive-disclosure)** - Claude-Mem 上下文启动策略背后的哲学
...
- **[钩子架构](https://docs.claude-mem-file.ai/hooks-architecture)** - Claude-Mem 如何使用生命周期钩子
...
- **[数据库](https://docs.claude-mem-file.ai/architecture/database)** - SQLite 模式与 FTS5 搜索
- **[搜索架构](https://docs.claude-mem-file.ai/architecture/search-architecture)** - 使用 Chroma 向量数据库的混合搜索
