...
- **[검색 아키텍처](https://docs.claude-mem-file.ai/architecture/search-architecture)** - Chroma 벡터 데이터베이스를 활용한 하이브리드 검색
...
- **문서**: [docs/](docs/)
- **이슈**: [GitHub Issues](https://github.com/thedotmack/claude-mem-file/issues)
- **저장소**: [github.com/thedotmack/claude-mem-file](https://github.com/thedotmack/claude-mem-file)
