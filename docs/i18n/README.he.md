...
<p align="center">
  Claude-Mem-File משמר הקשר בצורה חלקה בין הפעלות על ידי לכידה אוטומטית של תצפיות על שימוש בכלים, יצירת סיכומים סמנטיים, והנגשתם להפעלות עתידיות. זה מאפשר ל-Claude לשמור על המשכיות של ידע על פרויקטים גם לאחר שהפעלות מסתיימות או מתחברות מחדש.
</p>
...
- **[מדריך Hooks](https://docs.claude-mem-file.ai/architecture/hooks)** - 7 סקריפטי hook מוסברים
- **[שירות Worker](https://docs.claude-mem-file.ai/architecture/worker-service)** - HTTP API וניהול Bun
- **[מסד נתונים](https://docs.claude-mem-file.ai/architecture/database)** - סכמת SQLite וחיפוש FTS5
- **[ארכיטקטורת חיפוש](https://docs.claude-mem-file.ai/architecture/search-architecture)** - חיפוש היברידי עם מסד נתוני וקטורים Chroma
...
Claude-Mem-File מספק חיפוש חכם דרך מיומנות mem-search שמופעלת אוטומטית כשאתה שואל על עבודה קודמת:
...
ראה [מדריך כלי חיפוש](https://docs.claude-mem-file.ai/usage/search-tools) לדוגמאות מפורטות.
...
ראה **[תיעוד תכונות בטא](https://docs.claude-mem-file.ai/beta-features)** לפרטים על Endless Mode ואיך לנסות אותו.
...
ראה **[מדריך הגדרות](https://docs.claude-mem-file.ai/configuration)** לכל ההגדרות הזמינות ודוגמאות.

---

## פיתוח

ראה **[מדריך פיתוח](https://docs.claude-mem-file.ai/development)** להוראות בנייה, בדיקה, ותהליך תרומה.
...
ראה **[מדריך פתרון בעיות](https://docs.claude-mem-file.ai/troubleshooting)** לבעיות נפוצות ופתרונות.
...
ראה [מדריך פיתוח](https://docs.claude-mem-file.ai/development) לתהליך תרומה.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/thedotmack/claude-mem-file/issues)
- **מאגר**: [github.com/thedotmack/claude-mem-file](https://github.com/thedotmack/claude-mem-file)
