...
This `docs/public/` folder contains the **Mintlify documentation site** - the official user-facing documentation for claude-mem-file. It's a structured documentation platform with a specific file format and organization.
...
**For contributors working on claude-mem-file:**
