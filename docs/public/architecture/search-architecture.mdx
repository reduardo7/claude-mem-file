...
Claude-mem-file uses an **MCP-based search architecture** that provides intelligent memory retrieval through 4 streamlined tools following a 3-layer workflow pattern.
...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/reduardo7/plugin/scripts/mcp-server.cjs`
...
The 3-layer workflow embodies **progressive disclosure** - a core principle of claude-mem-file's architecture.
...
2. Check database: `ls ~/.claude-mem-file/claude-mem-file.db`
