...
Claude-Mem-File implements a **5-stage hook system** that captures development work across Claude Code sessions. This document provides a complete technical reference for developers implementing this pattern on other platforms.
...
// Removes <private>...</private> and <claude-mem-file-context>...</claude-mem-file-context>
...
<claude-mem-file-context>...</claude-mem-file-context>
```
