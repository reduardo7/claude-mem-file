...
description: "System components and data flow in Claude-Mem-File"
---
...
Claude-Mem-File operates as a Claude Code plugin with five core components:
...
- Location: `~/.claude-mem-file/claude-mem-file.db`
