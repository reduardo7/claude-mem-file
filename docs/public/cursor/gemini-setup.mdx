...
description: "Use Claude-Mem-File in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up Claude-Mem-File in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
## Step 2: Clone and Build Claude-Mem-File
...
Claude-mem-file automatically handles rate limiting for free tier usage:
