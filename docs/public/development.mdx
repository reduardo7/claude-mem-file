---
title: "Development"
description: "Build from source, run tests, and contribute to Claude-Mem-File"
---
...
Claude-mem-file relies on **real-world usage and manual testing** rather than traditional unit tests. The project philosophy prioritizes:
...
3. **Check database state**:
   ```bash
   sqlite3 ~/.claude-mem-file/claude-mem-file.db "SELECT * FROM your_table;"
   ```
