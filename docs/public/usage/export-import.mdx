...
description: "Share knowledge across claude-mem-file installations with duplicate prevention"
---

# Memory Export/Import Scripts

Share your claude-mem-file knowledge with other users! These scripts allow you to export specific memories (observations, sessions, summaries, and prompts) and import them into another claude-mem-file installation.
...
npx tsx scripts/export-memories.ts "bugfix" bugfixes.json --project=claude-mem-file
...
```
❌ Database not found at: /Users/you/.claude-mem-file/claude-mem-file.db
```

**Solution:** Make sure claude-mem-file is installed and has been run at least once.
