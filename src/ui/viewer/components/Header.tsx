  ...
  return (
    <div className="header">
      <div className="header-main">
        <h1>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <img src="claude-mem-file-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
            {queueDepth > 0 && (
          ...
          <span className="logo-text">claude-mem-file</span>
        </h1>
      ...
      <div className="status">
        <a
          href="https://docs.claude-mem-file.ai"
          target="_blank"
        ...
        <GitHubStarsButton username="thedotmack" repo="claude-mem-file" />
        <select
          value={currentFilter}
