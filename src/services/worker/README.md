...
The Worker Service is an Express HTTP server that handles all claude-mem-file operations. It runs on port 37777 (configurable via `CLAUDE_MEM_WORKER_PORT`) and is managed by PM2.
