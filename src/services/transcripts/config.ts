...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.claude-mem-file', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.claude-mem-file', 'transcript-watch-state.json');
